...
export async function showMainMenu(ctx: any, forceNew: boolean = false, deleteLast: boolean = true): Promise<void> {
  ...
  '🏠 <b>Главное меню</b>\n\n' +
    ...
    '<b>1. Фото чеков:</b> Камера, мотор, расход записан! 📸\n' +
    '<b>2. История:</b> Теперь листать её — одно удовольствие.\n' +
    '<b>3. Статистика:</b> Графики такие красивые, что хочется тратить больше (но не надо).\n\n' +
